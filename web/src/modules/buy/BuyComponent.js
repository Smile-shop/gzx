                ...
                <div className={this.state.chuangkou}>添加购物车成功</div>
                {
                    Array.isArray(data) && data.map((item)=>{
                        ...
                        <div className="shopping-cart">
                            ...
                            <div className="right">
                                <a id="btnAddCart" onClick={this.addItem.bind(this,{id:`${item.id}`,img:`${JSON.parse(item.banner)[0]}`,goodsName:`${item.goodTitle}`,newPrice:`${item.newPrice}`,oldPrice:`${item.oldPrice}`,qty:'1'})}>加入购物车</a>
                            </div>
                        </div>
                    </div>
                    })
